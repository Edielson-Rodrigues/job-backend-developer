...
import { ApiResponse } from 'src/utils/api-response.type';
...
export class CreateReviewService {
  ...
  public async execute(review: CreateReviewDTO): Promise<ApiResponse> {
    ...
    return {
      ...
      data: (new CreateReviewDTO).toResponse(newReview)
    }
  }
